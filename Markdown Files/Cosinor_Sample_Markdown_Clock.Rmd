...
readxl::read_excel(path ="../Your Data File.xlsx",
                   sheet = "Bmal1",
                    range ="Your Sheet Name") ->  Circadian_'Your Abbrev Compound Name'
...
if (!"24" %in% colnames( Circadian_'Your Abbrev Compound Name'_LD)) {
   Circadian_'Your Abbrev Compound Name'_LD <-  Circadian_'Your Abbrev Compound Name'_LD %>%
    mutate(`24` = `0`)}
...
if (!"24" %in% colnames( Circadian_'Your Abbrev Compound Name'_rLEN)) {
   Circadian_'Your Abbrev Compound Name'_rLEN <-  Circadian_'Your Abbrev Compound Name'_rLEN %>%
    mutate(`24` = `0`)}
```
