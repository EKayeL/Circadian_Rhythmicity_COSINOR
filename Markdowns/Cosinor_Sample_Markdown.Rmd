...
readxl::read_excel(path ="../Your Data File.xlsx",
                   sheet = 'Your Sheet Name',
                    range ="Your Range") -> Circadian_'Your Abbrev Compound Name'_LD

# Reading 'Your Measured Compound' Administered Rats for rLEN
readxl::read_excel(path ="../Your Data File.xlsx",
                   sheet = 'Your Sheet Name',
                    range ="our Range") -> Circadian_'Your Abbrev Compound Name'_rLEN
```
...
# Performs Data Carpentry on Filtered LD 'Your Measured Compound' Dataset and Removes 'NA's,
...
# Creating Cosinor Model for LD 'Your Measured Compound' Rat Plots
...
# Creating Cosinor Model for LD 'Your Measured Compound' Rat Data Analysis
cosinor.lm(`Concentration(mg)` ~ time(ZT), period = 24,
...
# Creating Cosinor Model for LD 'Your Measured Compound' Rat Plot Data Analysis
cosinor.lm(`Concentration(mg)` ~ time(ZT), period = 24,
...
# Creating Plot for LD 'Your Measured Compound' Rat Model
...
# Creating Plot for rLEN 'Your Measured Compound' Rat Model
